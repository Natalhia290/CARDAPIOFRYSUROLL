...
export const products: Product[] = [
  ...
  {
    id: 'combo-casal-salmao-sem-bebida',
    name: 'Sushidogroll Salmão Casal (sem bebida)',
    price: 49.99,
    description: 'Sushidogroll de salmão para 2 pessoas. Serve até 2 pessoas.',
    category: 'Combos Hot Rolls Dogs',
    image: '/images/products/combo-casal-salmao.jpg',
  },
  {
  ...
  {
    id: 'combo-casal-tilapia-sem-bebida',
    name: 'Sushidogroll Tilápia Casal (sem bebida)',
    price: 39.99,
    description: 'Sushidogroll de tilápia para 2 pessoas. Serve até 2 pessoas.',
    category: 'Combos Hot Rolls Dogs',
    image: '/images/products/combo-casal-tilapia.jpg',
  },
  {
  ...
  // Hots Barato mais que demais
  {
    ...
    price: 1.00,
    description: 'Hot para 1 pessoa. Máximo 40 unidades no carrinho.',
  ...
  // Sushidogroll barato até demais
  {
    ...
    price: 19.99,
    description: 'Mini hot dog de sushi recheado com salmão empanado e crocante, com cream cheese. (aprox. 160g). Serve até 1 pessoa.',
